...
<div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
        <div class="flex flex-col items-start">
            <div
                ...
                <br><br>
                Ainsi la formation des étudiants doit absolument conserver un caractère général pour leur permettre de s'adapter tout au long de leur carrière aux missions qui leur sont confiées.
                <br><br>
        ...
        <div
                ...
                <p>
                    ...
                    <br><br>
                    3 - <strong>Les technologies générales</strong> permettent aux étudiants de maîtriser les technologies de bases.
                    <br><br>
                    4 - <strong>Le stage en entreprise</strong> permet d'évaluer les performances des étudiants en entreprise.
                </p>
            </div>
        </div>
