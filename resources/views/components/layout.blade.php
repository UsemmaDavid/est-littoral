    ...
    <section id="accueil"
        ...
        <article class="lg:w-1/3">
          ...
          <p class="mt-4 max-w-md text-center text-2xl font-bold text-slate-700 dark:text-slate-400 lg:text-left">
              <span class="text-blue-700 dark:text-indigo-300">Télécommunications & Réseaux,<br>Systèmes Industriels,<br>Environnement<br>Hygiène et Sécurité,<br>Management des activités <br> maritimes</span>
          </p>
        </article>
