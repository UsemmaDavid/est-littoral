<div x-data="{            
    ...
    slides: [                
        {
            imgSrc: 'images/pnr/DSC_8185.jpg',
            imgAlt: 'Etudiants attentifs au cours',  
            title: '',
            description: '',           
        },                
        {
            imgSrc: 'images/pnr/DSC_8232.jpg',
            imgAlt: '',  
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8191.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8194.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8197.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8243.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8187.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8248.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8216.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
        {
            imgSrc: 'images/pnr/DSC_8229.jpg',
            imgAlt: '',
            title: '',
            description: '',
        },
...
}" x-init="autoplay" class="relative rounded-3xl w-full lg:w-2/3  overflow-hidden">
   
    <!-- slides -->
    <!-- Change min-h-[50svh] to your preferred height size -->
    <div class="relative min-h-[50svh] md:min-h-[70svh] w-full">
        <template x-for="(slide, index) in slides">
            <div x-cloak x-show="currentSlideIndex == index + 1" class="absolute inset-0" x-transition.opacity.duration.1000ms>
                ...
                <div class="lg:px-32 lg:py-14 absolute inset-0 z-10 flex flex-col items-center justify-end gap-2 bg-linear-to-t from-neutral-950/85 to-transparent px-16 py-12 text-center">
                    <h3 class="w-full lg:w-[80%] text-balance text-2xl lg:text-3xl font-bold text-blue-800" x-text="slide.title" x-bind:aria-describedby="'slide' + (index + 1) + 'Description'"></h3>
                ...
                <img class="absolute w-full h-full inset-0 object-scale-down md:object-cover text-neutral-600 dark:text-neutral-300" x-bind:src="slide.imgSrc" x-bind:alt="slide.imgAlt" />
            </div>
        </template>
    </div>
