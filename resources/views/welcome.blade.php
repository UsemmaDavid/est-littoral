<x-layout>
    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
        <div class="flex flex-col items-start">
            ...
            <div class="mt-5">
                <img src="{{ asset('images/EtudiantEntreprise.png') }}" class="rounded-lg">
            </div>
            <div
                ...
                <p>
                    ...
                    Le partenariat entre <strong> l'Ecole Supérieure de Technologie du Littoral</strong> et l'IUT d'Evry Val d'Essonne (France) repose sur une convention de partenariat scientifique et technique signée le 26 Mai 2001 à Paris.
        ...
        <div class="flex flex-col items-start">
            <div
                ...
                <p>
                    ...
                    <strong>EST-Littoral</strong> privilégie la formation en alternance afin de permettre aux étudiants de mieux appréhender les problématiques des entreprises et de répondre à leurs préoccupations.<br><br>
